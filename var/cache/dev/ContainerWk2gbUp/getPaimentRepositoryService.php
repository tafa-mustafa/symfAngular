...
// Returns the private 'App\Repository\PaimentRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/PaimentRepository.php';

return $this->privates['App\Repository\PaimentRepository'] = new \App\Repository\PaimentRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
