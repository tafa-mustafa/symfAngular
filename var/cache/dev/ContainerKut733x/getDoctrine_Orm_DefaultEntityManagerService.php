...
}, 'App\\Repository\\PaimentRepository' => function () {
    return ($this->privates['App\Repository\PaimentRepository'] ?? $this->load('getPaimentRepositoryService.php'));
...
}, 'App\\Repository\\ProreservationRepository' => function () {
    return ($this->privates['App\Repository\ProreservationRepository'] ?? $this->load('getProreservationRepositoryService.php'));
